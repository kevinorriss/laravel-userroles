                ...
                <div class="panel-body">
                    {!! Form::open(['url' => route('roles.update', $role->id), 'method' => 'PUT', 'class' => 'form-horizontal', 'role' => 'form']) !!}
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::text('name', old('name', $role->name), ['class' => 'form-control', 'placeholder' => 'role_name']) !!}
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::textarea('description', old('description', $role->description), ['class' => 'form-control', 'placeholder' => 'A description about what the role allows']) !!}
